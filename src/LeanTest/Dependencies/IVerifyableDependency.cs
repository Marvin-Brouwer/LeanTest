...
{
	TDependency Verify(ITimesConstraint times, Expression<Action<TService>> member);
	...
	TDependency VerifyOnce(Expression<Action<TService>> member);
	...
	TDependency VerifyExactly(uint amountOfTimes, Expression<Action<TService>> member);
	...
	TDependency VerifyAtLeast(uint amountOfTimes, Expression<Action<TService>> member);
	...
	TDependency VerifyAtMost(uint amountOfTimes, Expression<Action<TService>> member);
	...
	TDependency VerifyBetween(uint leastAmountOfTimes, uint mostAmountOfTimes,Expression<Action<TService>> member);
	...
	TDependency VerifyBetween(uint leastAmountOfTimes, uint mostAmountOfTimes, bool inclusive, Expression<Action<TService>> member);
	...
	TDependency VerifyNever(Expression<Action<TService>> member);
